...
async def on_spam_message(message: Message):
    """
    Ловушка для всего, что не подошло ни под один из хендлеров выше (в этом или
    в предыдущих роутерах): случайный текст, стикеры, голосовые, форварды,
